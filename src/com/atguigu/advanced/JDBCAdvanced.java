...
//        Class.forName("com.mysql.cj.jdbc.Driver");
        ...
        // 2.获取连接
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3307/atguigu?rewriteBatchedStatements=true", "root", "123456");

        // 3.编写SQL语句
        /*
        * 注意：1.必须在连接数据的URL后面追加?rewriteBatchedStatements=true，允许批量操作
